 ...
 *  - Colors: #c79f44 (gold), #1E1E22 (dark bg)
...
const NAV_PILLS = [
  ...
  { label: "Ai Drafting", icon: FolderLock, path: "/user-panel/drafting" },
  { label: "Notepad", icon: FolderLock, path: "/user-panel/notepad" },
];
    ...
    >
      ...
      >
        ...
        <div style={{ flex: 1, minWidth: 120 }}>
          ...
          <p
            style={{ margin: 0, fontSize: 12, color: "#9B9BA8", marginTop: 2 }}
          >
      ...
      >
        ...
        >
          ...
          {user?.province && (
            <InfoField icon={MapPin} label="Province" value={user?.province} />
          )}
        </div>
      </motion.div>
  ...
  const SidebarItem = ({ item }) => {
    ...
    return (
      <button
        ...
        onMouseEnter={(e) => {
          if (!active) e.currentTarget.style.background = DARK2;
        }}
        onMouseLeave={(e) => {
      ...
      >
        <Icon
          size={17}
          style={{ color: active ? GOLD : MUTED, flexShrink: 0 }}
        />
        <span
          style={{
            fontSize: 13,
    ...
    <>
      ...
      <header className="vol-mobile-header">
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <div>
            <p
              style={{ margin: 0, fontWeight: 800, fontSize: 12, color: WHITE }}
            >
              Voice Of Law AI
            </p>
            <p
