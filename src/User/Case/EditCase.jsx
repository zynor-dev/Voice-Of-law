...
const EditCase = () => {
  ...
  const sections = [
    { id: "case-info", name: "Case Information", icon: <FaGavel /> },
    { id: "party-info", name: "Party Information", icon: <FaUserTie /> },
    { id: "advocate-info", name: "Advocate Information", icon: <FaFileAlt /> },
  ];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const onBehalfOf = allowedOnBehalfOf.has(onBehalf)
        ? onBehalf
        : "petitioner";
  ...
  return (
    <div className="add-case-container">
      ...
      {/* Same structure/classes as AddCase so AddCase.css styling + mobile rules apply correctly */}
      <div className="add-case-topbar">
        <div className="topbar-left">
          ...
          <div className="case-title-section">
            <h2>Edit Case</h2>
            <span className="case-status pending">EDITING</span>
          </div>
        </div>
              ...
              <div className="form-progress">
                {sections.map((section) => (
                  <button
                    key={section.id}
                    type="button"
                    className={`progress-item ${activeSection === section.id ? "active" : ""}`}
                    onClick={() => setActiveSection(section.id)}
                  >
                    <span>{section.name}</span>
                  </button>
